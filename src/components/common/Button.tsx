...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200';
  
  const variantStyles = {
    primary: 'bg-blue-800 hover:bg-blue-900 text-white focus:ring-blue-600 dark:bg-blue-700 dark:hover:bg-blue-800',
